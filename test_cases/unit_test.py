from EC602_Twitter_Sentiment_Analysis_Project2 import *
import os.path
...
def test_Twitter_server_response():
	...
	"""
	rslt = False
	keyword = "Respect" #This should be a universal keyword.
...
def test_Google_server_response():
	...
	"""
	rslt = False
	test_text = 'respect is how you treat everyone'
	try:
